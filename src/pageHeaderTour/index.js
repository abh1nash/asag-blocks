...
const pageHeaderEditor = (props) => {
	// Creates a <p class='wp-block-cgb-block-asag-blocks'></p>.
	...
	const handleTourButtonTxtChange = (e) => {
		props.setAttributes({ tourButtonTxt: e });
	};
						...
						<div className="col-12 col-md-8 col-lg-6 align-self-center">
							...
							<div>
								<RichText
									tagName="a"
									className="cta-btn"
									placeholder="Tour Button"
									value={props.attributes.tourButtonTxt}
									onChange={handleTourButtonTxtChange}
								/>
							</div>
						</div>
					</div>
 ...
 */
registerBlockType("abhinash/tour-header", {
	// Block name. Block names must be string that contains a namespace prefix. Example: my-plugin/my-custom-block.
	title: __("Page Header with Tour"), // Block title.
					...
					<div className="row h-100">
						<div className="col-12 col-md-8 col-lg-6 align-self-center">
							...
							<div>
								...
								<button
									data-target="#faTourModal"
									data-toggle="modal"
									className="btn btn-outline-accent btn-lg text-white text-uppercase font-weight-bold"
								>
									{props.attributes.tourButtonTxt}
								</button>
							</div>
						</div>
					</div>
